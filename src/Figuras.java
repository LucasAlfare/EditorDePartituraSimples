            ...
            switch (pathAbsoluto.comando.toLowerCase()){
                ...
                case "c":
                    desenhista.curveTo(
                            ...
                            (pathAbsoluto.valores.get(2) + x) * escala,
                            (pathAbsoluto.valores.get(3) + y) * escala,

                            (pathAbsoluto.valores.get(4) + x) * escala,
                            (pathAbsoluto.valores.get(5) + y) * escala
                    );
                    break;
                case "z":
                    desenhista.closePath();
                    break;
            }
        }
    }
